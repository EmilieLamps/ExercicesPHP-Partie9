...
$timestampDate2 = time(); // La fonction time() permet d'afficher le timestamp du jour
...
include '../header.php';
 ...
 <p><?= intval($numberDays) ?> : c'est le nombre de jours qui séparent les 2 dates</p> <!-- INTVAL permet de n'afficher que l'entier de la variable -->
<?php
include '../footer.php';
?>